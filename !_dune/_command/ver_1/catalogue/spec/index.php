...
$session = Dune_Session::getInstance($session_zone);
    ...
    $display_main_info = new Module_Display_Catalogue_Object_ListSpecial();
...
Dune_Variables::addTitle('Все спецпредложения ');
    $view->h1_text = 'Все спецпредложения';
