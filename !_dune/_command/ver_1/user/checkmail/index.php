...
*/
        ...
        $mail->body = $view->render('mail/auth/registration_success');
        $mail->mail = $object->getResult('mail');
        $mail->name = 'Успешная регистрация пользователя ' . $object->login;
        $mail->subject = 'Регистрация на сайте: ' . Dune_Parameters::$siteDomain . '. Приглашение.';
        $mail->make();
