<?php
	...
	$bgcolor3 = $this->bgcolor3;
     ...
     $pagetitle = "Банки - первичка";


      Menu("ShowNovostroiBanks");
	...
	$banks = $seedHypBank->getNovostroiBankList();
	...
	$nukeSmarty->display('modules/Hypothec/templates/ShowNovostroiBanks.tpl');
