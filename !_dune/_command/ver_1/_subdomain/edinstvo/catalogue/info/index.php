...
$module = new Module_Sub_Display_ComplexHomeTable();
$module->complex = $object->group;
$module->house = $object->sub_house_id;
$module->make();
$text_adress = $module->getResult('data');
...
$display_crumbs = new Module_Display_SubDomain_Crumbs_ObjectPage();
$display_crumbs->object = $object;
$display_crumbs->make();
$text_crumbs = $display_crumbs->getOutput();
...
$display_main_info = new Module_Display_Catalogue_Object_InfoOneSub();
