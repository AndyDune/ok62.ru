...
*/    
    ...
    $object_condition = $object_condition->getList(2, false);
    ...
    $house_type = new Special_Vtor_Object_Add_Type(2);
    $view->house_type = $house_type->getListType();

    $walls = new Special_Vtor_Object_Add_MaterialWall();
...
//    $view->form_action = $folder_url->get() . $URL[6] . '/';
    ...
    echo $view->render('page/catalogue/object/edit/type_land');
}
