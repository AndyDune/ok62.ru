...
try {
    ...
    switch ($get->_do_)
    {
		...
		// Выборка информации о картинках модели
			...
			$mm_pics_info->local_folder = 'floor';
...
*/    
    ...
    // Передаем масви картинок
     $images = new Special_Vtor_Catalogue_Info_PlanFloor($view->data->id, $view->data->time_insert);
     $photos = array();     
...
//    $view->form_action = $folder_url->get() . $URL[6] . '/';
    ...
    echo $view->render('page/catalogue/object/edit/floor');
}
