...
//        $session->step = 1;
    ...
    Dune_Variables::$pageTitle = 'Продажа нежилого помещения. ' .  Dune_Variables::$pageTitle;
    Dune_Variables::$pageDescription = 'Отправка заявки на продажу нежилго помещения.';
