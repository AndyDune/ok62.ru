...
//        $session->step = 1;
    ...
    $view->steps_panel = $view->render('bit/sell/' . $object_type_code . '/auth/steps_panel');
    ...
    switch (true)
    {
        ...
        case ($session->step == 31):
            include(dirname(__FILE__) . '/step_31/index.php');
        break;
    ...
    Dune_Variables::$pageTitle = 'Продажа квартиры. ' .  Dune_Variables::$pageTitle;
    Dune_Variables::$pageDescription = 'Отправка заявки на продажу квартиры.';
