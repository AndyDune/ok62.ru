...
class Module_Catalogue_Object_PrivateTalk_PrepareMessage extends Dune_Include_Abstract_Code
{
...
*/    
    ...
    $cooc['have_private_message'] = 1;
    $url = Dune_Parameters::$pageInternalReferer;
    if ($pos = strpos($url, '?'))
    {
        $url = substr($url, 0, $pos);
    }
    $url .= '?talk_mode=private';
    $cooc['url'] = $url;
