...
class Module_Display_Catalogue_Filter_Type_Garage extends Dune_Include_Abstract_Code
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
        ...
        $view->house_type = $house_type->getListTypeWithObjectsActiveHave(3);
        $condition = new Special_Vtor_Object_Condition();
        $view->condition = $condition->getListWithObjects($this->type);
        echo $view->render('bit/catalogue/filter/type/garage');
