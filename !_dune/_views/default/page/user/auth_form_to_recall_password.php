<h1 id="h1-for-auth-forms">получение пароля</h1>
<p id="system-message"><?php echo $this->message;?></p>
<div id="user-enter-form-page">
<p><span><a href="/user/enter/">вход</a></span> <span><a href="/user/registration/">регистрация</a></span></p>
<form action="<?php echo $this->action; ?>" method="post">
<input name="_do_" type="hidden" value="recall" />
<dl id="user-logo-dl">
<dl id="user-password-dl">
<dt>Адрес электронной почты</dt>
<dd><input name="mail" type="text" value="<?php echo $this->mail; ?>" maxlength="30" /></dd>
</dl>
