<h1>Редактирование объекта. Ситуационный план.</h1>
<div id="edit-object-container">

<!--           Графика                   -->
<div id="edit-object-pics">
<h2>Ситуационный план</h2>
...
$o_hidden_do->setValue('save_situa');
echo $o_hidden_do;
...
<?php }?>
<p>Удалить: <a href="<?php echo $this->command_path_edit?>?_do_=delete_situa&id=<?php echo $this->data['id'];?>">Да</a></p>
