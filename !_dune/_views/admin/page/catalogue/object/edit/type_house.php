...
?>
<h1>Редактирование объекта Дом/Коттедж.</h1>
...
<tr>
<td class="add-object-prompting">Номер дома</td>
<td>
...
<tr>
<td class="add-object-prompting">Материал стен :</td>
<td>
...
<tr>
<td class="add-object-prompting">Земельный участок</td>
<td>
<?php 
...
echo $form;
?> / 
<input type="text" name="space_land" value="<?php echo $this->data['space_land']; ?>" class="input-1" /> соток
</td>
</tr>


<tr>
<td class="add-object-prompting">Гараж (указать число машиномест)</td>
<td>
<?php if ((int)$this->data['garage'] > 0)
{
    ...
    $text = '';
 ?>
 <input type="text" name="garage" value="<?php echo $text; ?>"  class="input-shot" /> шт.
</td>
</tr>


<tr>
<td class="add-object-prompting">Баня</td>
<td>
<?php 
...
<tr>
<td class="add-object-prompting">Вид водопровода <br /><em> (холодная вода)</em>:</td>
<td>
<?php
...
<tr>
<td class="add-object-prompting">Вид канализации:</td>
<td>
<?php
