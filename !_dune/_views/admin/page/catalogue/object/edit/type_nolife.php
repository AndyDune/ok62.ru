<h1>Редактирование объекта Нежилое помещение.</h1>
<p>Быстро:
...
<tr>
<td class="add-object-prompting">Номер помещения</td>
<td>
...
, цоколь <input type="checkbox" name="floor" value="-1"<?php
...
<tr>
<td class="add-object-prompting">Цена за аренду за <strong>1 кв.м.</strong></td>
<td>
<?php
$value = '';
if ($this->data['price_rent_metre'])  
{
    $value = number_format($this->data['price_rent_metre'], '0', '.',' ');
} ?>
<input name="price_rent_metre" type="text" value="<?php echo $value?>" /> </td>
</tr>
