<h1>Редактирование объекта Квартира. Планировка.</h1>
...
$o_hidden_do->setValue('save_plan');
echo $o_hidden_do;
...
<?php }?>
<p>Удалить: <a href="<?php echo $this->command_path_edit?>?_do_=delete_plan&id=<?php echo $this->data['id'];?>">Да</a></p>
