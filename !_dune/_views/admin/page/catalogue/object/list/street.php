<h1>Список улиц небольшого города. Число объектов.</h1>
<?php
...
{ 
	...
	?>/street-<?php echo $value['id']?>/" title="Список объектов в улице"><?php echo $value['name']?></a></td>
	
	<td class="list-td-id"><?php echo $value['count_total']?></td>
	<td class="list-td-id"><?php echo $value['count_active']?></td>

	
	<td class="list-td-text-mid"><a href="<?php echo $this->link_object_list;?>/street-<?php echo $value['id']?>/">Объекты.&nbsp;Список.</a></td>
	</tr>
	<?php
} ?> </table>
<?php
