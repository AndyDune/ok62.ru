...
<tr>
<td>Название </td><td>
<input name="name" type="text" value="<?php echo $this->data_settlement['name'] ?>" />
</td>
</tr>
...
{
    if ($value['id'] == $this->data_settlement['type'])
...
<tr>
<td>Порядок </td><td>
<input name="order" type="text" value="<?php echo $this->data_settlement['order'] ?>" />
</td>
</tr>
<tr>
<td>Популяция </td><td>
<input name="population" type="text" value="<?php echo $this->data_settlement['population'] ?>" />
</td>
<tr>


</table>
<input name="id" type="hidden" value="<?php echo $this->data_settlement['id'] ?>" />
