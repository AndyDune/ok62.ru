<h1>Список улиц района города</h1>
<?php
...
{ 
	...
	<td class="list-td-text-shot"><a href="<?php echo $this->link_edit;?>/<?php echo $value['id']?>/" title="Список объектов в улице"><?php echo $value['name']?></a></td>
...
?>
<ul>
<li><a href="<?php echo $this->link_add;?>">Добавить улицу</a></li>
</ul>
