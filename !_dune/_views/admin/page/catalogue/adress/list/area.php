...
{ 
	...
	<td class="list-td-text-shot"><a href="<?php echo $this->link_next_list;?>/<?php echo $value['id']?>/" title="Список городов района"><?php echo $value['name']?></a></td>
...
?>
<ul>
<li><a href="<?php echo $this->link_add;?>">Добавить район</a></li>
</ul>
