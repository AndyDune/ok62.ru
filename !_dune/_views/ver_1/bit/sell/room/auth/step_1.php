...
<input name="space_total" type="text" value="<?php echo $this->data['space_total']?>"  class="input-1" /> 
 / 
 <input name="space_living" type="text" value="<?php echo $this->data['space_living']?>"  class="input-1" /> 
 / 
<input name="space_kitchen" type="text" value="<?php echo $this->data['space_kitchen']?>"  class="input-1" /> кв. м.
</td>
</tr>
...
<td>
<input class="input-1" name="space_calculation" type="text" value="<?php echo $this->data['space_calculation']?>" maxlength=" 10" /> кв. м.
</td>
</tr>
...
<td>
<input name="rooms_count" type="text" value="<?php echo $this->data['rooms_count']?>" class="input-0" maxlength="3" /> 
