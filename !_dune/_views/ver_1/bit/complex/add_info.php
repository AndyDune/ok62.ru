...
if ($this->photo)
{
    ?><dl class="pic-text"><dt><a href="<?php echo $this->url ?>photo/">Фоторепортаж</a></dt><dd><a class="thickbox" href="<?php echo $this->photo->getSourseFileUrl(); ?>" title="Оригинал фотографии"><img src="<?php echo $this->photo->getPreviewFileUrl(250); ?>" /></a> </dd></dl> <?php
}
?>
