...
<ul class="ul-param-two-on-line" style="margin: 5px 0 0 0;">
 ...
 площадь:
 с <input type="text" name="value_from_land" value="<?php echo $this->saved['value_from_land']; ?>" size="6">
</p>
<p style="margin:0;padding:2px 0 5px 62px; ">
по <input type="text" name="value_to_land" value="<?php echo $this->saved['value_to_land']; ?>" size="6"> соток
</p>
 </li>
