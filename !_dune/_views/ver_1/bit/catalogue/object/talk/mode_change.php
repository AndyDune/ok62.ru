...
<li><a href="<?php echo $this->url_object->get();?>?talk_mode=public#talk-mode-change" title="Сообщения, доступные для просмотра всем рользователям сайта."><span><em>Комментарии</em></span></a></li>
