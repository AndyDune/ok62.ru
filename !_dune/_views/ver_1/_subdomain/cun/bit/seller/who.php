...
<?php if ($value['id_rel']) {
if ($value['contact_name_rel'])
    $add_name = ' (' . $value['contact_name_rel'] . ')';
else 
    $add_name = '';
    
    ?>
<p class="p-general-info" style="color:green; font-weight: bold;">Относится к пользователю: <a  style="color:green;" href="/user/info/<?php echo $value['id_rel']; ?>/"><?php echo $value['name_rel'], $add_name;  ?></a></p>
<?php } ?>
<p>Дата регистрации:
...
<p class="p-general-info" style="color:blue; font-weight: bold;">Всего в системе продает: <a href="/seller/?seller=<?php echo $value['id']; ?>"><?php echo $value['count_objects'];  ?></a></p>
