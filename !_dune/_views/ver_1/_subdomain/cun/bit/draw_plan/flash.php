...
<?php if ($this->look) {
    $url = '#';
    ?>
<p><a  class="buttom" href="/public/plan/info/<?php echo $this->look; ?>/">Посмотреть картинку</a></p>
<?php } else 
{
...
<p>Изображение доступно для публичного просмотра. <a href="/public/plan/info/<?php echo $this->look; ?>/frompublic/">Скрыть</a></p>
<?php } ?>
