...
Квартиры в стояке на этажах: <?php
$x = 0;
...
$link = $value['link']  .'mode/group/';  
    ?>
<a href="<?php echo $link; ?>" title="Квартир в стояке: <?php echo $this->object->count_in_group; ?>">
...
<span class="no-wrap"><?php echo number_format($value['price_rent_day'], 0, ',', ' ')?></span> руб./сутки

<?php } else if ($value['price_rent']) { ?>
<span class="no-wrap"><?php echo number_format($value['price_rent'], 0, ',', ' ')?></span> <span class="no-wrap">руб./месяц</span>
<?php } else if ($value['price']) { ?>
<span class="no-wrap price-new"><?php echo number_format($value['price'], 0, ',', ' ')?></span> руб.</span>

<?php } else if ($value['price_one']) { ?>
<span class="no-wrap price-new"><?php echo number_format($value['price_one'], 0, ',', ' ')?></span> руб./1м<sup>2</sup></span>
