...
<?php if ($this->object->balcony or $this->object->space_balcony) { ?>
...
else if ($this->object->price_rent_metre)
{
?><p class="p-object-shot-price">Цена аренды 1м<sup>2</sup>: <span class="focus-red"><?php echo number_format($this->object->price_rent_metre, '0', '.',' ')?> руб./месяц</span>
</p><?php

} else if (!$this->object->price)
{
