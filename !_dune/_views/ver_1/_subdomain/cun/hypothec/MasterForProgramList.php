...
<h2> Результат работы мастра подбора программы.</h2>

<a id="to-search" href="/modules.php?name=Hypothec&op=MasterForProgram&page=<?php echo $this->levels_count ?>">Вернуться в мастер</a>
...
<th class="<?php echo $this->name_pp_class;?>"><a href="/modules.php?name=Hypothec&op=MasterForProgramList&_do_=order&col_name=name_pp" title="Сортировать по колонке.">Программа</a></th>
<?php
...
?>
<th class="<?php echo $this->currencyid_pp_class;?>"><a href="/modules.php?name=Hypothec&op=MasterForProgramList&_do_=order&col_name=currencyid_pp">Валюта</a></th>
<th class="<?php echo $this->firstpayment_pp_class;?>"><a href="/modules.php?name=Hypothec&op=MasterForProgramList&_do_=order&col_name=firstpayment_pp">Первый взнос</a></th>
<th class="<?php echo $this->rate_pp_class;?>"><a href="/modules.php?name=Hypothec&op=MasterForProgramList&_do_=order&col_name=rate_pp">Ставка</a></th>
<th class="<?php echo $this->creditperiod_pp_class;?>"><a href="/modules.php?name=Hypothec&op=MasterForProgramList&_do_=order&col_name=creditperiod_pp">Срок кредита</a></th>

<th class="<?php echo $this->sumcreditmin_pp_class;?>"><a href="/modules.php?name=Hypothec&op=MasterForProgramList&_do_=order&col_name=sumcreditmin_pp">Размер кредита (мин.)</a></th>
<th class="<?php echo $this->sumcreditmax_pp_class;?>"><a href="/modules.php?name=Hypothec&op=MasterForProgramList&_do_=order&col_name=sumcreditmax_pp">Размер кредита (макс.)</a></th>
<th></th>
</tr>
...
<?php foreach ($this->array as $program) {?>
	...
	<a class="b-name-in-shot-table" href="/modules.php?name=Hypothec&op=ShowFixedBank&bankID=<?php echo $program['bank_id'];?>" title="Описание банка"><?php echo $program['name'];?></a>
	</td>
...
*/?>	
	...
	<?php if ($program['creditperiod_pp']) echo $program['creditperiod_pp'];
	   ...
	   if ($this->age) // Если был указан возраст в мастере
	   {
	       $to_p = $program['agemax'] - $this->age;
	       if ($to_p <= 0)
	       {
                echo '(<a class="tt" href="#pensia" title="Указаный при подборе возраст превышает пенсионный.">*</a>)<br />';	           
	       }
