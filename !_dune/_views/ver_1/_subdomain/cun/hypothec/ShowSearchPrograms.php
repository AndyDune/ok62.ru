...
<a id="to-search" href="/modules.php?name=Hypothec&op=SearchPrograms">Изменить параметры поиска</a>
...
<th class="<?php echo $this->name_pp_class;?>"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=name_pp" title="Сортировать по колонке.">Программа</a></th>
<?php
//<th class="<? php echo $this->kinds_pp_class;? >"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=kinds_pp" title="Сортировать по колонке.">Вид кредитования</a></th>
?>
<th class="<?php echo $this->currencyid_pp_class;?>"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=currencyid_pp">Валюта</a></th>
<th class="<?php echo $this->firstpayment_pp_class;?>"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=firstpayment_pp">Первый взнос</a></th>
<th class="<?php echo $this->rate_pp_class;?>"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=rate_pp">Ставка</a></th>
<th class="<?php echo $this->creditperiod_pp_class;?>"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=creditperiod_pp">Срок кредита</a></th>

<th class="<?php echo $this->sumcreditmin_pp_class;?>"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=sumcreditmin_pp">Размер кредита (мин.)</a></th>
<th class="<?php echo $this->sumcreditmax_pp_class;?>"><a href="/modules.php?name=Hypothec&op=ShowSearchPrograms&_do_=order&col_name=sumcreditmax_pp">Размер кредита (макс.)</a></th>
