...
{
    $adress = 'adress' . Special_Vtor_Settings::$districtPlusPostFix . '/';
}
else 
{
    $adress = '';
...
<a href="/catalogue/type/<?php echo $value['type']; ?>/object/<?php echo $value['id']; ?>/<?php echo $adress; ?>" title="Подробная инфомация об объекте">
<?php
