<h1>Рисование планировки</h1>
<p>Вы неавторизованный пользователь. Вы не можете сохранить результат и получить отзывы.</p>
<?php
// echo $this->steps_panel;
$this->setResult('title', 'Рисование планировки. ');
?>
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="900" height="800" id="planningFlash">
				...
				<param name="flashvars" value="phpSid=<?php echo $this->session_id; ?>&amp;saveXml=/public/plan/draw/do_savexml/&amp;savePng=/public/plan/draw/do_savepng/&amp;loadXml=/public/plan/draw/do_loadxml/&amp;url=#" />
				<!--[if !IE]>-->
