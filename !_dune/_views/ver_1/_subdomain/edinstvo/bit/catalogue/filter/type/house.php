...
<h5>этажность:</h5>
<ul class="ul-like-table ul-like-table-100">
 <li><input type="checkbox" name="floor_count_1" value="1" <?php
 if ($this->saved['floor_count_1'])
 {
 ?>checked="checked" <?php    
 }
 ?>> 1</li>
 <li><input type="checkbox" name="floor_count_2" value="1" <?php
 if ($this->saved['floor_count_2'])
 {
 ?>checked="checked" <?php    
 }
 ?>> 2</li>
 <li><input type="checkbox" name="floor_count_0" value="1" <?php
 if ($this->saved['floor_count_0'])
 {
 ?>checked="checked" <?php    
 }
 ?>> более 2-х</li>
...
<ul class="ul-like-table ul-like-table-100">
<?php foreach ($this->type_add as $key => $value) {?>
 <li><input type="checkbox" name="type_add[<?php echo $value['id'];?>]" value="<?php echo $value['id'];?>" <?php
 if (isset($this->saved['type_add'][$value['id']]))
 {
 ?>checked="checked" <?php    
 }
...
<ul class="ul-like-table ul-like-table-100">
<?php foreach ($this->type_wall as $key => $value) {?>
 <li><input type="checkbox" name="type_wall[<?php echo $value['id'];?>]" value="<?php echo $value['id'];?>" <?php
 if (isset($this->saved['type_wall'][$value['id']]))
 {
 ?>checked="checked" <?php    
 }
 ?>> <?php echo $value['name']; ?></li>
