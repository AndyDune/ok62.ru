а продажу нежилого помещения.</h1>

<p>Заявка на размещеие нежилого помещения в каталоге от пользователя <a href="http://<?php echo $this->domain ?>/user/info/<?php echo $this->user_id ?>"><?php echo $this->user_name ?></a></p>
