...
<th class="<?php echo $this->sumcreditmin_pp_class;?>"><a href="/modules.php?name=Hypothec&op=CalculationList&version=<?php echo $this->version; ?>&_do_=order&col_name=sumcreditmin_pp">Размер кредита</a></th>
<th class="<?php echo $this->sumcreditmin_pp_class;?>">Переплата по процентам</th>
<th class="<?php echo $this->sumcreditmin_pp_class;?>">Платеж в 1-й месяц</th>
<th class="<?php echo $this->sumcreditmin_pp_class;?>">Платеж в 1-й месяц (<a target="_blank" title="Программа развития ипотечного кредитования строящихся объектов Строим вместе" href="/modules.php?name=Hypothec&op=Privilege">льгота</a>)</th>
...
<th class="<?php echo $this->creditperiod_pp_class;?>"><a href="/modules.php?name=Hypothec&op=CalculationList&version=<?php echo $this->version; ?>&_do_=order&col_name=creditperiod_pp">Срок кредита (года)</a></th>
